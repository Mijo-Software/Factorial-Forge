namespace FactorialForge
{
    partial class MainForm
    {
		...
		private void InitializeComponent()
		{
			...
			this.tabPageRisingFactorial = new TabPage();
			this.labelRisingFactorialN = new Label();
			this.numericUpDownRisingFactorialN = new NumericUpDown();
			this.buttonDigitStatisticsRisingFactorial = new Button();
			this.buttonSaveToFileRisingFactorial = new Button();
			this.buttonCopyToClipboardRisingFactorial = new Button();
			this.labelRisingFactorialX = new Label();
			this.textBoxRisingFactorial = new TextBox();
			this.numericUpDownRisingFactorialX = new NumericUpDown();
			this.tabPageFallingFactorial = new TabPage();
			this.labelFallingFactorialN = new Label();
			this.numericUpDownFallingFactorialN = new NumericUpDown();
			this.buttonDigitStatisticsFallingFactorial = new Button();
			this.buttonSaveToFileFallingFactorial = new Button();
			this.buttonCopyToClipboardFallingFactorial = new Button();
			this.labelFallingFactorialX = new Label();
			this.textBoxFallingFactorial = new TextBox();
			this.numericUpDownFallingFactorialX = new NumericUpDown();
			this.tabPageMultiFactorial = new TabPage();
			this.labelMultiFactorialN = new Label();
			this.numericUpDownMultiFactorialN = new NumericUpDown();
			this.buttonDigitStatisticsMultiFactorial = new Button();
			this.buttonSaveToFileMultiFactorial = new Button();
			this.buttonCopyToClipboardMultiFactorial = new Button();
			this.labelMultiFactorialX = new Label();
			this.textBoxMultiFactorial = new TextBox();
			this.numericUpDownMultiFactorialX = new NumericUpDown();
			this.tabPageSuperfactorial = new TabPage();
			this.buttonDigitStatisticsSuperfactorial = new Button();
			this.buttonSaveToFileSuperfactorial = new Button();
			this.buttonCopyToClipboardSuperfactorial = new Button();
			this.labelSuperfactorial = new Label();
			this.textBoxSuperfactorial = new TextBox();
			this.numericUpDownSuperfactorial = new NumericUpDown();
			this.tabPageHyperfactorial = new TabPage();
			this.buttonDigitStatisticsHyperfactorial = new Button();
			this.buttonSaveToFileHyperfactorial = new Button();
			this.buttonCopyToClipboardHyperfactorial = new Button();
			...
			this.tabPageRisingFactorial.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)this.numericUpDownRisingFactorialN).BeginInit();
			((System.ComponentModel.ISupportInitialize)this.numericUpDownRisingFactorialX).BeginInit();
			this.tabPageFallingFactorial.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)this.numericUpDownFallingFactorialN).BeginInit();
			((System.ComponentModel.ISupportInitialize)this.numericUpDownFallingFactorialX).BeginInit();
			this.tabPageMultiFactorial.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)this.numericUpDownMultiFactorialN).BeginInit();
			((System.ComponentModel.ISupportInitialize)this.numericUpDownMultiFactorialX).BeginInit();
			this.tabPageSuperfactorial.SuspendLayout();
			...
			this.tabControl.Controls.Add(this.tabPageRisingFactorial);
			this.tabControl.Controls.Add(this.tabPageFallingFactorial);
			this.tabControl.Controls.Add(this.tabPageMultiFactorial);
			this.tabControl.Controls.Add(this.tabPageSuperfactorial);
			this.tabControl.Controls.Add(this.tabPageHyperfactorial);
			this.tabControl.Controls.Add(this.tabPageSuperduperfactorial);
			...
			this.tabControl.Size = new Size(719, 364);
			...
			this.tabPageFactorial.Location = new Point(4, 53);
			this.tabPageFactorial.Name = "tabPageFactorial";
			this.tabPageFactorial.Padding = new Padding(3);
			this.tabPageFactorial.Size = new Size(711, 307);
			...
			this.textBoxFactorial.Size = new Size(705, 269);
			...
			// 
			// tabPageRisingFactorial
			// 
			this.tabPageRisingFactorial.Controls.Add(this.labelRisingFactorialN);
			this.tabPageRisingFactorial.Controls.Add(this.numericUpDownRisingFactorialN);
			this.tabPageRisingFactorial.Controls.Add(this.buttonDigitStatisticsRisingFactorial);
			this.tabPageRisingFactorial.Controls.Add(this.buttonSaveToFileRisingFactorial);
			this.tabPageRisingFactorial.Controls.Add(this.buttonCopyToClipboardRisingFactorial);
			...
			this.buttonDigitStatisticsRisingFactorial.UseVisualStyleBackColor = true;
			this.buttonDigitStatisticsRisingFactorial.Click += this.ButtonDigitStatisticsRisingFactorial_Click;
			// 
			...
			this.buttonSaveToFileRisingFactorial.UseVisualStyleBackColor = true;
			this.buttonSaveToFileRisingFactorial.Click += this.ButtonSaveToFileRisingFactorial_Click;
			// 
			...
			this.buttonCopyToClipboardRisingFactorial.TabIndex = 5;
			this.buttonCopyToClipboardRisingFactorial.Text = "Copy to clipboard";
			this.buttonCopyToClipboardRisingFactorial.TextAlign = ContentAlignment.MiddleRight;
			this.buttonCopyToClipboardRisingFactorial.TextImageRelation = TextImageRelation.ImageBeforeText;
			this.buttonCopyToClipboardRisingFactorial.UseVisualStyleBackColor = true;
			this.buttonCopyToClipboardRisingFactorial.Click += this.ButtonCopyToClipboardRisingFactorial_Click;
			// 
			// labelRisingFactorialX
			// 
			...
			// 
			this.textBoxRisingFactorial.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
			this.textBoxRisingFactorial.Location = new Point(3, 35);
			this.textBoxRisingFactorial.MaxLength = int.MaxValue;
			this.textBoxRisingFactorial.Multiline = true;
			...
			this.numericUpDownRisingFactorialX.ValueChanged += this.NumericUpDownRisingFactorialX_ValueChanged;
			// 
			// tabPageFallingFactorial
			// 
			this.tabPageFallingFactorial.Controls.Add(this.labelFallingFactorialN);
			this.tabPageFallingFactorial.Controls.Add(this.numericUpDownFallingFactorialN);
			this.tabPageFallingFactorial.Controls.Add(this.buttonDigitStatisticsFallingFactorial);
			this.tabPageFallingFactorial.Controls.Add(this.buttonSaveToFileFallingFactorial);
			this.tabPageFallingFactorial.Controls.Add(this.buttonCopyToClipboardFallingFactorial);
			...
			this.buttonDigitStatisticsFallingFactorial.UseVisualStyleBackColor = true;
			this.buttonDigitStatisticsFallingFactorial.Click += this.ButtonDigitStatisticsFallingFactorial_Click;
			// 
			...
			this.buttonSaveToFileFallingFactorial.UseVisualStyleBackColor = true;
			this.buttonSaveToFileFallingFactorial.Click += this.ButtonSaveToFileFallingFactorial_Click;
			// 
			...
			this.buttonCopyToClipboardFallingFactorial.UseVisualStyleBackColor = true;
			this.buttonCopyToClipboardFallingFactorial.Click += this.ButtonCopyToClipboardFallingFactorial_Click;
			// 
			// labelFallingFactorialX
			// 
			...
			// 
			this.textBoxFallingFactorial.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
			this.textBoxFallingFactorial.Location = new Point(3, 35);
			this.textBoxFallingFactorial.MaxLength = int.MaxValue;
			this.textBoxFallingFactorial.Multiline = true;
			...
			this.numericUpDownFallingFactorialX.ValueChanged += this.NumericUpDownFallingFactorialX_ValueChanged;
			// 
			// tabPageMultiFactorial
			// 
			this.tabPageMultiFactorial.Controls.Add(this.labelMultiFactorialN);
			this.tabPageMultiFactorial.Controls.Add(this.numericUpDownMultiFactorialN);
			this.tabPageMultiFactorial.Controls.Add(this.buttonDigitStatisticsMultiFactorial);
			this.tabPageMultiFactorial.Controls.Add(this.buttonSaveToFileMultiFactorial);
			this.tabPageMultiFactorial.Controls.Add(this.buttonCopyToClipboardMultiFactorial);
			this.tabPageMultiFactorial.Controls.Add(this.labelMultiFactorialX);
			this.tabPageMultiFactorial.Controls.Add(this.textBoxMultiFactorial);
			this.tabPageMultiFactorial.Controls.Add(this.numericUpDownMultiFactorialX);
			this.tabPageMultiFactorial.Location = new Point(4, 53);
			this.tabPageMultiFactorial.Name = "tabPageMultiFactorial";
			this.tabPageMultiFactorial.Padding = new Padding(3);
			this.tabPageMultiFactorial.Size = new Size(711, 307);
			this.tabPageMultiFactorial.TabIndex = 8;
			this.tabPageMultiFactorial.Text = "Multi Factorial";
			this.tabPageMultiFactorial.UseVisualStyleBackColor = true;
			// 
			// labelMultiFactorialN
			// 
			...
			this.numericUpDownMultiFactorialN.TextAlign = HorizontalAlignment.Center;
			this.numericUpDownMultiFactorialN.Value = new decimal(new int[] { 1, 0, 0, 0 });
			this.numericUpDownMultiFactorialN.ValueChanged += this.NumericUpDownMultiFactorialN_ValueChanged;
			// 
			...
			this.buttonDigitStatisticsMultiFactorial.TabIndex = 15;
			this.buttonDigitStatisticsMultiFactorial.Text = "Digit statistics";
			this.buttonDigitStatisticsMultiFactorial.TextAlign = ContentAlignment.MiddleRight;
			this.buttonDigitStatisticsMultiFactorial.TextImageRelation = TextImageRelation.ImageBeforeText;
			this.buttonDigitStatisticsMultiFactorial.UseVisualStyleBackColor = true;
			this.buttonDigitStatisticsMultiFactorial.Click += this.ButtonDigitStatisticsMultiFactorial_Click;
			// 
			...
			this.buttonSaveToFileMultiFactorial.TabIndex = 14;
			this.buttonSaveToFileMultiFactorial.Text = "Save to file";
			this.buttonSaveToFileMultiFactorial.TextAlign = ContentAlignment.MiddleRight;
			this.buttonSaveToFileMultiFactorial.TextImageRelation = TextImageRelation.ImageBeforeText;
			this.buttonSaveToFileMultiFactorial.UseVisualStyleBackColor = true;
			this.buttonSaveToFileMultiFactorial.Click += this.ButtonSaveToFileMultiFactorial_Click;
			// 
			...
			this.buttonCopyToClipboardMultiFactorial.TabIndex = 13;
			this.buttonCopyToClipboardMultiFactorial.Text = "Copy to clipboard";
			this.buttonCopyToClipboardMultiFactorial.TextAlign = ContentAlignment.MiddleRight;
			this.buttonCopyToClipboardMultiFactorial.TextImageRelation = TextImageRelation.ImageBeforeText;
			this.buttonCopyToClipboardMultiFactorial.UseVisualStyleBackColor = true;
			this.buttonCopyToClipboardMultiFactorial.Click += this.ButtonCopyToClipboardMultiFactorial_Click;
			// 
			// labelMultiFactorialX
			// 
			...
			// 
			this.textBoxMultiFactorial.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
			this.textBoxMultiFactorial.Location = new Point(3, 35);
			this.textBoxMultiFactorial.MaxLength = int.MaxValue;
			this.textBoxMultiFactorial.Multiline = true;
			this.textBoxMultiFactorial.Name = "textBoxMultiFactorial";
			this.textBoxMultiFactorial.PlaceholderText = "Multi Factorial";
			this.textBoxMultiFactorial.ScrollBars = ScrollBars.Vertical;
			this.textBoxMultiFactorial.Size = new Size(705, 269);
			this.textBoxMultiFactorial.TabIndex = 12;
			// 
			...
			this.numericUpDownMultiFactorialX.TextAlign = HorizontalAlignment.Center;
			this.numericUpDownMultiFactorialX.ValueChanged += this.NumericUpDownMultiFactorialX_ValueChanged;
			// 
			// tabPageSuperfactorial
			// 
			this.tabPageSuperfactorial.Controls.Add(this.buttonDigitStatisticsSuperfactorial);
			this.tabPageSuperfactorial.Controls.Add(this.buttonSaveToFileSuperfactorial);
			this.tabPageSuperfactorial.Controls.Add(this.buttonCopyToClipboardSuperfactorial);
			this.tabPageSuperfactorial.Controls.Add(this.labelSuperfactorial);
			this.tabPageSuperfactorial.Controls.Add(this.textBoxSuperfactorial);
			this.tabPageSuperfactorial.Controls.Add(this.numericUpDownSuperfactorial);
			this.tabPageSuperfactorial.Location = new Point(4, 53);
			this.tabPageSuperfactorial.Name = "tabPageSuperfactorial";
			this.tabPageSuperfactorial.Padding = new Padding(3);
			this.tabPageSuperfactorial.Size = new Size(711, 307);
			this.tabPageSuperfactorial.TabIndex = 9;
			this.tabPageSuperfactorial.Text = "Superfactorial";
			this.tabPageSuperfactorial.UseVisualStyleBackColor = true;
			// 
			...
			this.buttonDigitStatisticsSuperfactorial.TabIndex = 23;
			this.buttonDigitStatisticsSuperfactorial.Text = "Digit statistics";
			this.buttonDigitStatisticsSuperfactorial.TextAlign = ContentAlignment.MiddleRight;
			this.buttonDigitStatisticsSuperfactorial.TextImageRelation = TextImageRelation.ImageBeforeText;
			this.buttonDigitStatisticsSuperfactorial.UseVisualStyleBackColor = true;
			this.buttonDigitStatisticsSuperfactorial.Click += this.ButtonDigitStatisticsSuperfactorial_Click;
			// 
			...
			this.buttonSaveToFileSuperfactorial.TabIndex = 22;
			this.buttonSaveToFileSuperfactorial.Text = "Save to file";
			this.buttonSaveToFileSuperfactorial.TextAlign = ContentAlignment.MiddleRight;
			this.buttonSaveToFileSuperfactorial.TextImageRelation = TextImageRelation.ImageBeforeText;
			this.buttonSaveToFileSuperfactorial.UseVisualStyleBackColor = true;
			this.buttonSaveToFileSuperfactorial.Click += this.ButtonSaveToFileSuperfactorial_Click;
			// 
			...
			this.buttonCopyToClipboardSuperfactorial.TabIndex = 21;
			this.buttonCopyToClipboardSuperfactorial.Text = "Copy to clipboard";
			this.buttonCopyToClipboardSuperfactorial.TextAlign = ContentAlignment.MiddleRight;
			this.buttonCopyToClipboardSuperfactorial.TextImageRelation = TextImageRelation.ImageBeforeText;
			this.buttonCopyToClipboardSuperfactorial.UseVisualStyleBackColor = true;
			this.buttonCopyToClipboardSuperfactorial.Click += this.ButtonCopyToClipboardSuperfactorial_Click;
			// 
			// labelSuperfactorial
			// 
			...
			// 
			this.textBoxSuperfactorial.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
			this.textBoxSuperfactorial.Location = new Point(3, 35);
			this.textBoxSuperfactorial.MaxLength = int.MaxValue;
			this.textBoxSuperfactorial.Multiline = true;
			this.textBoxSuperfactorial.Name = "textBoxSuperfactorial";
			this.textBoxSuperfactorial.PlaceholderText = "Superfactorial";
			this.textBoxSuperfactorial.ScrollBars = ScrollBars.Vertical;
			this.textBoxSuperfactorial.Size = new Size(705, 269);
			this.textBoxSuperfactorial.TabIndex = 20;
			// 
			...
			this.numericUpDownSuperfactorial.TextAlign = HorizontalAlignment.Center;
			this.numericUpDownSuperfactorial.ValueChanged += this.NumericUpDownSuperfactorial_ValueChanged;
			// 
			// tabPageHyperfactorial
			// 
			this.tabPageHyperfactorial.Controls.Add(this.buttonDigitStatisticsHyperfactorial);
			this.tabPageHyperfactorial.Controls.Add(this.buttonSaveToFileHyperfactorial);
			this.tabPageHyperfactorial.Controls.Add(this.buttonCopyToClipboardHyperfactorial);
			this.tabPageHyperfactorial.Controls.Add(this.labelHyperfactorial);
			this.tabPageHyperfactorial.Controls.Add(this.textBoxHyperfactorial);
			this.tabPageHyperfactorial.Controls.Add(this.numericUpDownHyperfactorial);
			this.tabPageHyperfactorial.Location = new Point(4, 53);
			this.tabPageHyperfactorial.Name = "tabPageHyperfactorial";
			this.tabPageHyperfactorial.Size = new Size(711, 307);
			this.tabPageHyperfactorial.TabIndex = 10;
			this.tabPageHyperfactorial.Text = "Hyperfactorial";
			this.tabPageHyperfactorial.UseVisualStyleBackColor = true;
			// 
			...
			this.buttonDigitStatisticsHyperfactorial.TabIndex = 29;
			this.buttonDigitStatisticsHyperfactorial.Text = "Digit statistics";
			this.buttonDigitStatisticsHyperfactorial.TextAlign = ContentAlignment.MiddleRight;
			this.buttonDigitStatisticsHyperfactorial.TextImageRelation = TextImageRelation.ImageBeforeText;
			this.buttonDigitStatisticsHyperfactorial.UseVisualStyleBackColor = true;
			this.buttonDigitStatisticsHyperfactorial.Click += this.ButtonDigitStatisticsHyperfactorial_Click;
			// 
			...
			this.buttonSaveToFileHyperfactorial.TabIndex = 28;
			this.buttonSaveToFileHyperfactorial.Text = "Save to file";
			this.buttonSaveToFileHyperfactorial.TextAlign = ContentAlignment.MiddleRight;
			this.buttonSaveToFileHyperfactorial.TextImageRelation = TextImageRelation.ImageBeforeText;
			this.buttonSaveToFileHyperfactorial.UseVisualStyleBackColor = true;
			this.buttonSaveToFileHyperfactorial.Click += this.ButtonSaveToFileHyperfactorial_Click;
			// 
			...
			this.buttonCopyToClipboardHyperfactorial.TabIndex = 27;
			this.buttonCopyToClipboardHyperfactorial.Text = "Copy to clipboard";
			this.buttonCopyToClipboardHyperfactorial.TextAlign = ContentAlignment.MiddleRight;
			this.buttonCopyToClipboardHyperfactorial.TextImageRelation = TextImageRelation.ImageBeforeText;
			this.buttonCopyToClipboardHyperfactorial.UseVisualStyleBackColor = true;
			this.buttonCopyToClipboardHyperfactorial.Click += this.ButtonCopyToClipboardHyperfactorial_Click;
			// 
			// labelHyperfactorial
			// 
			...
			// 
			this.textBoxHyperfactorial.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
			this.textBoxHyperfactorial.Location = new Point(3, 35);
			this.textBoxHyperfactorial.MaxLength = int.MaxValue;
			this.textBoxHyperfactorial.Multiline = true;
			this.textBoxHyperfactorial.Name = "textBoxHyperfactorial";
			this.textBoxHyperfactorial.PlaceholderText = "Hyperfactorial";
			this.textBoxHyperfactorial.ScrollBars = ScrollBars.Vertical;
			this.textBoxHyperfactorial.Size = new Size(705, 269);
			this.textBoxHyperfactorial.TabIndex = 26;
			// 
			...
			this.toolStripStatusLabelInfo.Size = new Size(602, 17);
			...
			this.toolStripContainer.ContentPanel.Size = new Size(719, 364);
			...
			this.ClientSize = new Size(719, 386);
			...
			this.tabPageRisingFactorial.ResumeLayout(false);
			this.tabPageRisingFactorial.PerformLayout();
			((System.ComponentModel.ISupportInitialize)this.numericUpDownRisingFactorialN).EndInit();
			((System.ComponentModel.ISupportInitialize)this.numericUpDownRisingFactorialX).EndInit();
			this.tabPageFallingFactorial.ResumeLayout(false);
			this.tabPageFallingFactorial.PerformLayout();
			((System.ComponentModel.ISupportInitialize)this.numericUpDownFallingFactorialN).EndInit();
			((System.ComponentModel.ISupportInitialize)this.numericUpDownFallingFactorialX).EndInit();
			this.tabPageMultiFactorial.ResumeLayout(false);
			this.tabPageMultiFactorial.PerformLayout();
			((System.ComponentModel.ISupportInitialize)this.numericUpDownMultiFactorialN).EndInit();
			((System.ComponentModel.ISupportInitialize)this.numericUpDownMultiFactorialX).EndInit();
			this.tabPageSuperfactorial.ResumeLayout(false);
			this.tabPageSuperfactorial.PerformLayout();
			((System.ComponentModel.ISupportInitialize)this.numericUpDownSuperfactorial).EndInit();
		...
		private TabPage tabPageRisingFactorial;
		private TabPage tabPageFallingFactorial;
		private Button buttonDigitStatisticsRisingFactorial;
		private Button buttonSaveToFileRisingFactorial;
		private Button buttonCopyToClipboardRisingFactorial;
		private Label labelRisingFactorialX;
		private TextBox textBoxRisingFactorial;
		private NumericUpDown numericUpDownRisingFactorialX;
		private Button buttonDigitStatisticsFallingFactorial;
		private Button buttonSaveToFileFallingFactorial;
		private Button buttonCopyToClipboardFallingFactorial;
		private Label labelFallingFactorialX;
		private TextBox textBoxFallingFactorial;
		private NumericUpDown numericUpDownFallingFactorialX;
		private Label labelRisingFactorialN;
		private NumericUpDown numericUpDownRisingFactorialN;
		private Label labelFallingFactorialN;
		private NumericUpDown numericUpDownFallingFactorialN;
		private TabPage tabPageMultiFactorial;
		private Label labelMultiFactorialN;
		private NumericUpDown numericUpDownMultiFactorialN;
		private Button buttonDigitStatisticsMultiFactorial;
		private Button buttonSaveToFileMultiFactorial;
		private Button buttonCopyToClipboardMultiFactorial;
		private Label labelMultiFactorialX;
		private TextBox textBoxMultiFactorial;
		private NumericUpDown numericUpDownMultiFactorialX;
		private TabPage tabPageSuperfactorial;
		private Button buttonDigitStatisticsSuperfactorial;
		private Button buttonSaveToFileSuperfactorial;
		private Button buttonCopyToClipboardSuperfactorial;
		private Label labelSuperfactorial;
		private TextBox textBoxSuperfactorial;
		private NumericUpDown numericUpDownSuperfactorial;
		private TabPage tabPageHyperfactorial;
		private Button buttonDigitStatisticsHyperfactorial;
		private Button buttonSaveToFileHyperfactorial;
		private Button buttonCopyToClipboardHyperfactorial;
		private Label labelHyperfactorial;
